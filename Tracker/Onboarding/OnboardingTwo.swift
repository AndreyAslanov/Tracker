...
class OnboardingTwo: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let backgroundImage = UIImageView(image: UIImage(named: "OnboardingTwoBackground"))
        ...
        pageControl.numberOfPages = 2 // Общее количество экранов Onboarding
        pageControl.currentPage = 1 // Индекс второго экрана
